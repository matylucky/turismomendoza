...
<nav class="navbar navbar-inverse">
 ...
 <div class="container">
        <div class="jumbotron">
            <h1>Listado de las Leñas Fecha 3</h1>
       <font color="blue"> <b> <?php include('lenasesf3.php');?></b></font>
         
        </div>
    </div>

    <a href="lenas.php" class="btn btn-info btn-lg" role="button">volver a reporte Leñas</a>

    <a href="admin.php" class="btn btn-info btn-lg" role="button">Volver a inicio</a>
