...
*/
 $query = "INSERT INTO $tbl_name3 (USU_ID, PAQ_ID,) VALUES ('$_POST[email]', '$_POST[paquete2]')";
 $query = "INSERT INTO $tbl_name2 (PAS_NOMBRE, PAS_DNI) VALUES ('$_POST[username]', '$_POST[dni]')";
